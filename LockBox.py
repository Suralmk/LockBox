...
"}")
        ...
        self.close_btn.setGeometry(QRect(860, 0, 40, 39))
        self.close_btn.setMinimumSize(QSize(40, 39))
...
"}")
        icon = QIcon()
        icon.addFile(u":/icons/src/icons/close-large-line.png", QSize(), QIcon.Normal, QIcon.Off)
        self.close_btn.setIcon(icon)
        self.close_btn.setIconSize(QSize(15, 15))
        self.minimize_btn = QPushButton(self.title_bar)
        self.minimize_btn.setObjectName(u"minimize_btn")
        self.minimize_btn.setGeometry(QRect(820, 0, 40, 39))
        self.minimize_btn.setMinimumSize(QSize(40, 3))
        self.minimize_btn.setMaximumSize(QSize(40, 39))
        self.minimize_btn.setStyleSheet(u"")
        icon1 = QIcon()
        icon1.addFile(u":/icons/src/icons/subtract-line.png", QSize(), QIcon.Normal, QIcon.Off)
        self.minimize_btn.setIcon(icon1)
        self.label_12 = QLabel(self.title_bar)
        self.label_12.setObjectName(u"label_12")
        self.label_12.setGeometry(QRect(20, 0, 141, 40))
...
"    }")
        ...
        self.label_14.setGeometry(QRect(10, 10, 351, 31))
        self.label_14.setStyleSheet(u"font: 16pt \"Segoe UI\";\n"
"color:rgba(240, 247, 255,1);\n"
"background:transparent;")
        self.frame_5 = QFrame(self.homepage)
        self.frame_5.setObjectName(u"frame_5")
        self.frame_5.setGeometry(QRect(20, 100, 201, 131))
        self.frame_5.setStyleSheet(u"background:rgba(204, 212, 48, 0.5)")
        self.frame_5.setFrameShape(QFrame.Shape.NoFrame)
        self.label_15 = QLabel(self.frame_5)
        self.label_15.setObjectName(u"label_15")
        self.label_15.setGeometry(QRect(10, 10, 121, 31))
        self.label_15.setStyleSheet(u"font: 12pt \"Segoe UI\";\n"
"color:rgba(240, 247, 255,1);\n"
"background:transparent;\n"
"font-weight:bold;")
        self.label_16 = QLabel(self.frame_5)
        self.label_16.setObjectName(u"label_16")
        self.label_16.setGeometry(QRect(10, 50, 51, 21))
        self.label_16.setStyleSheet(u"border-radius:0px;\n"
"background:transparent;\n"
"font: 20pt \"Segoe UI\";\n"
"font-weight:bold;")
        self.frame_6 = QFrame(self.homepage)
        self.frame_6.setObjectName(u"frame_6")
        self.frame_6.setGeometry(QRect(250, 100, 201, 131))
        self.frame_6.setStyleSheet(u"background:rgba(69, 72, 208, 0.5)")
        self.frame_6.setFrameShape(QFrame.Shape.NoFrame)
        self.label_17 = QLabel(self.frame_6)
        self.label_17.setObjectName(u"label_17")
        self.label_17.setGeometry(QRect(10, 10, 121, 31))
        self.label_17.setStyleSheet(u"font: 12pt \"Segoe UI\";\n"
"color:rgba(240, 247, 255,1);\n"
"background:transparent;\n"
"font-weight:bold;")
        self.label_22 = QLabel(self.frame_6)
        self.label_22.setObjectName(u"label_22")
        self.label_22.setGeometry(QRect(10, 50, 51, 21))
...
"font-weight:bold;")
        ...
        self.frame_8.setGeometry(QRect(20, 250, 661, 181))
        self.frame_8.setStyleSheet(u"background:white;")
        self.frame_8.setFrameShape(QFrame.Shape.NoFrame)
        self.label_18 = QLabel(self.frame_8)
        self.label_18.setObjectName(u"label_18")
        self.label_18.setGeometry(QRect(20, 20, 141, 21))
        self.label_18.setStyleSheet(u"font: 16pt \"Segoe UI\";\n"
"color:black;")
        self.label_19 = QLabel(self.homepage)
        self.label_19.setObjectName(u"label_19")
        self.label_19.setGeometry(QRect(30, 450, 561, 31))
...
"background:transparent;")
        ...
        self.textEdit_4 = QTextEdit(self.encryptpage)
        self.textEdit_4.setObjectName(u"textEdit_4")
        self.textEdit_4.setGeometry(QRect(10, 70, 671, 411))
        self.textEdit_4.setStyleSheet(u"background:rgba(0,0,0,0.8);\n"
"border-radius:5px;\n"
"color:rgba(255, 255, 255, 0.8);\n"
"font: 11pt \"Segoe UI\";")
        self.encrypt_select_file = QPushButton(self.encryptpage)
...
"border-radius:5px;")
        ...
        self.encrypt_start_btn = QPushButton(self.encryptpage)
...
"border-radius:5px;")
        ...
        self.label_24 = QLabel(self.encryptpage)
...
"font-weight:bold;")
        ...
        self.gridLayout_3 = QGridLayout(self.dcryptpage)
        self.gridLayout_3.setObjectName(u"gridLayout_3")
        self.dcrypt_logs = QTextEdit(self.dcryptpage)
...
"font: 11pt \"Segoe UI\";")
        ...
        self.frame = QFrame(self.dcryptpage)
...
"}")
        ...
        icon2 = QIcon()
        icon2.addFile(u":/icons/src/icons/home.png", QSize(), QIcon.Normal, QIcon.Off)
        self.homepage_btn_2.setIcon(icon2)
...
"}")
        ...
        self.label_21 = QLabel(self.dcryptpage)
...
"}")
        ...
        icon3 = QIcon()
        icon3.addFile(u":/icons/src/icons/links-line.png", QSize(), QIcon.Normal, QIcon.Off)
        self.visit_website_btn.setIcon(icon3)
        ...
        self.homepage_btn.setIcon(icon2)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/icons/src/icons/lock.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/icons/src/icons/unlock.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/icons/src/icons/help.png", QSize(), QIcon.Normal, QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_15.setText(QCoreApplication.translate("MainWindow", u"Encrypted Files", None))
        self.label_16.setText(QCoreApplication.translate("MainWindow", u"50", None))
        self.label_17.setText(QCoreApplication.translate("MainWindow", u"File Type", None))
        self.label_22.setText(QCoreApplication.translate("MainWindow", u"2", None))
        self.label_23.setText(QCoreApplication.translate("MainWindow", u"File Type", None))
        self.label_18.setText(QCoreApplication.translate("MainWindow", u"How it works?", None))
        self.label_19.setText(QCoreApplication.translate("MainWindow", u"Encrypt Images, Audio, Video, Documents, Folders and Files.", None))
        ...
        self.label_24.setText(QCoreApplication.translate("MainWindow", u"Encrypt Files", None))
        ...
        self.label_21.setText(QCoreApplication.translate("MainWindow", u"Dcrypt Files", None))
